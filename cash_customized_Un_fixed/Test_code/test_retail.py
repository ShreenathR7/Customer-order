...
class Test_Logimax:
    ...
    def test_Billing(self,booting_function):   
        ...
        assert self.driver.title == 'Logimax Technology | Admin'
        print('product name  : {a}'.format( a = 'RING & COIN'))
        sleep(20)
        ...
        assert self.driver.title == 'Logimax Technology | Admin'
        print('design name  : {a}'.format( a = 'ARAM'))
        sleep(5)        
        ...
        sleep(5)        
        self.driver.find_element(by=By.XPATH,value=locators.Logi_Locators().size).click()
        sleep(5)
        size = self.driver.find_element(by=By.XPATH,value=locators.Logi_Locators().text_box)
        size.send_keys('5 INCH')
        size.send_keys(Keys.RETURN) 
        assert self.driver.title == 'Logimax Technology | Admin'
        print('Size : {a}'.format( a = '5 INCH'))
        sleep(5)
